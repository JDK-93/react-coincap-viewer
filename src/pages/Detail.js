    ...
    <>
      {detail.loading ? (
        ...
        <div class="h-full w-full lg:w-2/3">
          <div class="h-auto w-full flex flex-col text-center text-lg font-medium text-gray-700 py-4 bg-yellow-300 border-b-2 rounded-t-md p-4">
            <div className=" min-w-max flex flex-row justify-between items-center py-2">
              <div className="flex flex-row">
                ...
                />
                <div className="pl-4">
                  <div className="w-max text-3xl font-base text-yellow-600 ">
                    {detail.data.name}
                  </div>
                  <div className="text-xl font-base text-left text-yellow-500">
                    {detail.data.symbol}
                  </div>
                </div>
              </div>
              <div className="flex flex-col">
                <button
                  className=" font-base text-yellow-600 py-2 px-4 border-2 bg-yellow-400 border-yellow-500 rounded-lg hover:bg-yellow-500 hover:text-yellow-600"
                  onClick={() => handleClick()}
                >
                  Volver
                </button>
            ...
            <div className=" w-full flex flex-row border-b border-yellow-300 px-2">

             

              <div className="w-1/4 flex flex-col justify-center items-center py-2">
                <div className="w-max text-sm font-base text-yellow-600 ">
                  ${min(assetHistory.data).toFixed(2)}
                </div>
                <div className="text-xs font-base text-left text-yellow-500">
                  MÍNIMO
                </div>
              </div>
